...
function getWeather() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const response = yield fetch(`https://api.darksky.net/forecast/${(0,core.getInput)("DarkSkySecretKey")}/${(0,core.getInput)("Latitude")},${(0,core.getInput)("Longitude")}?exclude=hourly,daily`, {
                method: "GET",
                headers: {
...
function getMessage(report) {
    const units = report.flags.units == "us" ? "℉" : "℃";
    let message = `${report.minutely.summary} ${Math.round(report.currently.temperature)}${units}`;
    // let us know if actual temperature differs from apparent temperature
    if (Math.round(report.currently.apparentTemperature) !==
        Math.round(report.currently.temperature)) {
        message += ` (feels like ${Math.round(report.currently.apparentTemperature)}${units})`;
    }
    return message;
}
...
function src_status() {
    return src_awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield updateSlackStatus(report);
        }
        catch (error) {
...
/* harmony default export */ const src = (src_status());
